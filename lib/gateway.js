...
/* harmony export */ });
/* harmony import */ var _post_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./post.js */ "./src/auth/post.js");
...
function auth () {
  return {
    createToken: _post_js__WEBPACK_IMPORTED_MODULE_0__.createToken.bind(this)
  }
}
...
/* harmony import */ var _interceptors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./interceptors */ "./src/support/interceptors.js");



axios__WEBPACK_IMPORTED_MODULE_0___default().interceptors.request.use(_interceptors__WEBPACK_IMPORTED_MODULE_1__.requestInterceptor, _interceptors__WEBPACK_IMPORTED_MODULE_1__.errorRequestInterceptor)
axios__WEBPACK_IMPORTED_MODULE_0___default().interceptors.response.use(_interceptors__WEBPACK_IMPORTED_MODULE_1__.responseInterceptor, _interceptors__WEBPACK_IMPORTED_MODULE_1__.errorResponseInterceptor)

const request = {
  get: endpoint => axios__WEBPACK_IMPORTED_MODULE_0___default().get(endpoint).then(res => Promise.resolve(res)).catch(e => Promise.reject(e)),
  post: (endpoint, body) => axios__WEBPACK_IMPORTED_MODULE_0___default().post(endpoint, body).then(res => Promise.resolve(res)).catch(e => Promise.reject(e)),
  delete: (endpoint, body) => axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"](endpoint, { data: body }).then(res => Promise.resolve(res)).catch(e => Promise.reject(e)),
  put: (endpoint, body) => axios__WEBPACK_IMPORTED_MODULE_0___default().put(endpoint, body).then(res => Promise.resolve(res)).catch(e => Promise.reject(e)),
  patch: (endpoint, body) => axios__WEBPACK_IMPORTED_MODULE_0___default().patch(endpoint, body).then(res => Promise.resolve(res)).catch(e => Promise.reject(e))
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "errorRequestInterceptor": () => (/* binding */ errorRequestInterceptor),
/* harmony export */   "errorResponseInterceptor": () => (/* binding */ errorResponseInterceptor),
...
function verifyAuth (config, token) {
  if (token) {
...
function requestInterceptor (config) {
  const token = js_cookie__WEBPACK_IMPORTED_MODULE_0__["default"].get(`demo-tk_${this.env}`)
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ GatewayService)
/* harmony export */ });
/* harmony import */ var _auth__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./auth */ "./src/auth/index.js");
/* harmony import */ var _support__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./support */ "./src/support/index.js");
...
class GatewayService {
  constructor (options) {
    ...
    this.request = _support__WEBPACK_IMPORTED_MODULE_1__["default"]
    this.env = options.env
    this.url = options.url
    this.auth = _auth__WEBPACK_IMPORTED_MODULE_0__["default"].bind(this)()
