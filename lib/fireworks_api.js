(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("FireworksAPI", [], factory);
	else if(typeof exports === 'object')
		exports["FireworksAPI"] = factory();
	else
		root["FireworksAPI"] = factory();
})(self, function() {
...
function createToken (body) {
  return this.request.post(`${this.url}/login`, body)
    .then((res) => {
      ...
      js_cookie__WEBPACK_IMPORTED_MODULE_0__["default"].set(`fw-tk_${this.env}`, res.token, { expires, path, domain })
...
function requestInterceptor (config) {
  const token = js_cookie__WEBPACK_IMPORTED_MODULE_0__["default"].get(`fw-tk_${this.env}`)
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ FireworksService)
/* harmony export */ });
